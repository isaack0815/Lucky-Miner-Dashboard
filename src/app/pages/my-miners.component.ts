    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Verwalte alle deine LuckyMiner im Detail.</p>
        </div>
          ...
          @for (miner of minerService.miners(); track miner.id) {
            <div class="miner-card">
              ...
              <div class="miner-details">
                ...
                <div class="stats-row">
                  <div class="stat-mini">
                    ...
                    <span class="stat-mini-value">{{ miner.hashrate.toFixed(1) }} TH/s</span>
                  </div>
                  <div class="stat-mini">
              ...
              <div class="card-actions">
                <button class="btn-action" title="Neustarten">

...
import { NavigationService, PageView } from '../services/navigation.service';
...
@Component({
  ...
  template: `
    <aside class="sidebar">
      ...
      <nav class="nav-menu">
        <a href="#" class="nav-item" [class.active]="nav.currentView() === 'dashboard'" (click)="navigate($event, 'dashboard')">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
          Dashboard
        </a>
        <a href="#" class="nav-item" [class.active]="nav.currentView() === 'miners'" (click)="navigate($event, 'miners')">
        ...
        <a href="#" class="nav-item" [class.active]="nav.currentView() === 'stats'" (click)="navigate($event, 'stats')">
        ...
        <a href="#" class="nav-item" [class.active]="nav.currentView() === 'settings'" (click)="navigate($event, 'settings')">
...
export class SidebarComponent {
  ...
  navigate(event: Event, view: PageView) {
